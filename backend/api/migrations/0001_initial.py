    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_number', models.CharField(blank=True, max_length=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('medic_profile', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.medicprofile')),
